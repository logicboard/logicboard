defmodule LogicboardWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LogicboardWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LogicboardWeb.Gettext, "errors", msg, opts)
    end
  end
